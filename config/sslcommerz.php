<?php
    ...
    return [
        ...
        'route' => [
            'success'   =>  env('SSLC_ROUTE_SUCCESS','payment.success'),
            'failure'   =>  env('SSLC_ROUTE_FAILURE','payment.failure'),
            'cancel'    =>  env('SSLC_ROUTE_CANCEL','payment.cancel'),
            'ipn'       =>  env('SSLC_ROUTE_IPN','payment.ipn'),
        ],
